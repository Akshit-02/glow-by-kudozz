      ...
      <div className="mt-8 grid grid-cols-1 items-center gap-10 lg:grid-cols-2">
        <Reveal className="flex flex-col gap-5">
          ...
          <p className="text-lg leading-relaxed text-muted-foreground">
            ...
            different — an editorial team of licensed estheticians, grooming
            specialists, and a board-certified dermatologist, publishing
            guidance that holds up to scrutiny.
          </p>
